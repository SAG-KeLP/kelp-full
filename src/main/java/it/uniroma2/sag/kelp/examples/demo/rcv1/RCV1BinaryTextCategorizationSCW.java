...
public class RCV1BinaryTextCategorizationSCW extends
		RCV1BinaryTextCategorization {
	protected String algoSuffix = "SCW";
	...
	public static void main(String[] args) {
		...
		RCV1BinaryTextCategorization foldLearning = new RCV1BinaryTextCategorizationSCW();
		foldLearning.foldLearn(c, nfold, allData);
	}

	@Override
	protected LearningAlgorithm getLearningAlgorithm(float param,
			String representation, StringLabel positiveLabel) {

		SCWType scwType = SCWType.SCW_II;

		float eta = 0.95f;

		SoftConfidenceWeightedClassification algo = new SoftConfidenceWeightedClassification(
				scwType, eta, param, param, representation);
