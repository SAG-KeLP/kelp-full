...
import it.uniroma2.sag.kelp.learningalgorithm.classification.hmm.SequenceClassificationLearningAlgorithm;
import it.uniroma2.sag.kelp.learningalgorithm.classification.hmm.SequenceClassificationLinearLearningAlgorithm;
 ...
 * as a feature vector, <b>the following code implements a very efficient
 * learning process operating in the feature space.</b> <br>
 * During the training step, each example is enriched to consider its history,
 * in terms of classes assigned to the previous example(s). <br>
...
public class SequenceLearningLinearMain {
	...
	public static void main(String[] args) throws Exception {
		...
		String classificationOutputFile = "src/main/resources/sequence_learning/seq_labeling_lin_classifier.klp";
		 ...
		 * Sequence classifier.
		 */
		SequenceClassificationLearningAlgorithm sequenceClassificationLearningAlgorithm = new SequenceClassificationLinearLearningAlgorithm(
